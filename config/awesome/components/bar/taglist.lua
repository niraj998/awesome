...
-- pacman taglist.
-- credits to elenapan's dotfiles.

-- number of tags, also add keyboard shortcuts, if you change this since they are set for six tags only same as here.
local ntags = 6

-- function create taglist.
local function taglist(s)
    ...
    gears.table.join(
      ...
      awful.button({ }, 2, function ()
        awful.spawn.with_shell(apps.run)
      end),
...
-- updatewidget on change of tags/client
