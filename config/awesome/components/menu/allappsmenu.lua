...
-- this generates menu for all of the apps you have in system but it takes alot of time on the start so uncommented.
-- if you want to try it out go to init.lua in menu folder. comment out other menu and uncomment this one.
